    ...
    <div class="content">
      ...
      <div class="cen-box">
        ...
        <div class="dr-center">
          <a id="downlink"></a>
          <el-col :span="6">
            <el-button type="success" plain @click="exportExcel('还款记录表')" size="mini">导出Excel表</el-button>
          </el-col>
        </div>
      </div>
      ...
      >
        ...
        <el-table-column v-if="show" prop="processNo" label="案件号" align="center"></el-table-column>

        <!-- <el-table-column prop="channelCode" label="进件渠道" align="center">
        </el-table-column>-->
        <el-table-column prop="productCode" label="子产品" align="center"></el-table-column>
        <el-table-column prop="actualPrin" label="还款本金" align="center"></el-table-column>
        <el-table-column prop="actualInt" label="还款利息" align="center"></el-table-column>
        <el-table-column prop="repayAmt" label="还款金额合计" align="center"></el-table-column>
        <!-- <el-table-column prop="repayType" label="还款渠道" align="center">
        </el-table-column>-->
        <!-- <el-table-column prop="statementType" label="还款方式" align="center">
        </el-table-column>-->
        <el-table-column prop="repayStatus" label="还款状态" align="center"></el-table-column>
        <el-table-column prop="repayTime" label="还款日期" align="center"></el-table-column>
      </el-table>
      <div class="block">
        <el-pagination
          background
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      this.$http
        .post(
          this.$store.state.domain + "/loanManage/loanRepay",
          this.searchform
        )
        .then(
          response => {
            if (response.data.code == 0) {
              ...
              if (response.data.detail.result.params == null) {
                ...
                this.allmoney =
                  response.data.detail.result.params.repayAmtTotal;
              }
