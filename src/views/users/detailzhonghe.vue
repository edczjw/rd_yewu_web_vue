<template>
  <div>
    ...
    <div class="outpadding">
          <!-- <p class="xiangqingtitle"><i class="el-icon-location-outline"></i>山东临沂</p> -->

          <el-tabs v-model="tabname" type="card">
            <!-- 有两大板块，分别来自不同的页面 -->
            <el-tab-pane label="基本信息" name="userbasezhonghe"></el-tab-pane>
            <el-tab-pane label="影像信息" name="userpics"></el-tab-pane>
          </el-tabs>
          <userbasezhonghe v-if="tabname=='userbasezhonghe'"></userbasezhonghe>
          <userpics v-if="tabname=='userpics'"></userpics>
    </div>
  </div>
</template>
<script>
import userbasezhonghe from "./userbasezhonghe.vue";
...
export default {
  data() {
    return {
      isFullscreen: false,
      detail: {},
      tabname: "userbasezhonghe",//默认打开的是基本信息
