  ...
  <div>
    ...
    <div class="outpadding">
      ...
      <el-tabs v-model="tabname" type="card">
        <!-- 有两大板块，分别来自不同的页面 -->
        <el-tab-pane label="基本信息" name="userbaseqianhai"></el-tab-pane>
        <el-tab-pane label="影像信息" name="userpics"></el-tab-pane>
      </el-tabs>
      <userbaseqianhai v-if="tabname=='userbaseqianhai'"></userbaseqianhai>
      <userpics v-if="tabname=='userpics'"></userpics>
    </div>
  </div>
</template>
<script>
import userbaseqianhai from "./userbaseqianhai.vue";
...
export default {
  data() {
    return {
      isFullscreen: false,
      detail: {},
      tabname: "userbaseqianhai",//默认打开的是基本信息
