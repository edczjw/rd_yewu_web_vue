  ...
  <div>
    ...
    <div class="outpadding">
      ...
      <el-tabs v-model="tabname" type="card">
        <!-- 有两大板块，分别来自不同的页面 -->
        <el-tab-pane label="基本信息" name="userbaseyunkedai"></el-tab-pane>
        <el-tab-pane label="影像信息" name="userpics"></el-tab-pane>
      </el-tabs>
      <userbaseyunkedai v-if="tabname=='userbaseyunkedai'"></userbaseyunkedai>
      <userpics v-if="tabname=='userpics'"></userpics>
    </div>
  </div>
</template>
<script>
import userbaseyunkedai from "./userbaseyunkedai.vue";
...
export default {
  data() {
    return {
      isFullscreen: false,
      detail: {},
      tabname: "userbaseyunkedai",//默认打开的是基本信息
